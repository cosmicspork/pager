...
- `extension/` — Chrome MV3 capture extension. Posts events to the bridge, and
  optionally holds your Teams presence. Toggles in its popup/options page.
...
active* (off by default — holds your Teams presence while the tab is open), and
shows whether the bridge is reachable. The options page has the pulse interval
and the capture endpoint. See `extension/README.md`.
